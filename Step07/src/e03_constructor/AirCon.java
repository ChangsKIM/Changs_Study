 ...
 * 			
 * 			온도Up / Down, 바람세기변경, 운전모드변경, 전원OnOff
 * 			초기화
 */
public class AirCon {
	boolean power;
	...
	final int WIND_POWER_LOW = 0;
	final int WIND_POWER_MID = 1;
	final int WIND_POWER_HIGH = 2;
	...
	void changeMode() {
		...
		switch(mode) {
		case MODE_COLD:
			System.out.println("현재 냉방 모드 입니다.");
			break;
		case MODE_DEHUMI:
			System.out.println("현재 제습 모드 입니다.");
			break;
		case MODE_NATURAL:
			System.out.println("현재 송풍 모드 입니다.");
			break;
		}
	}
